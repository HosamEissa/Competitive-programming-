...
int main()
{
    ...
    while(t--){
        ...
        double ang1=getAng(p2,p1,p3)*180/PI;
        double ang2=getAng(p4,p3,p1)*180/PI;
        while(ang1>=360)ang1-=360;
        while(ang2>=360)ang2-=360;
        while(ang1>180)ang1=360-ang1;
        while(ang2>180)ang2=360-ang2;;
        int ans=dcmp(ang1,ang2);
       // cout<<ang1<<" "<<ang2<<" "<<ans<<endl;
        if(ans==0){
